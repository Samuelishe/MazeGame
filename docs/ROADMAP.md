...
4. evaluate `maze_game.py` block timer extraction before enemy/world update helpers
...
6. Re-evaluate whether `maze_game.py` block timers, world rendering, or `ui.py` has a similarly safe later split
